...
# Firebase Service Account JSON fayl yo'li. Bo'sh bo'lsa push yuborilmaydi
# (loglanadi), tizim boshqa aspektlarda ishlayveradi.
...
# Karzinka Lavka token Proxyman'dan qo'lda olinadi va ~1 soatda tugaydi;
# yangilash uchun Proxyman'dan yangi webview token oling.
...
# Sentry — DSN bo'sh bo'lsa Sentry yoqilmaydi.
